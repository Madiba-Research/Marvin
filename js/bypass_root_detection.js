setTimeout(function () {
    Java.perform(function () {
        ...
        Java.use("android.app.ApplicationPackageManager").getPackageInfoAsUser.overload('java.lang.String', 'int', 'int').implementation = function (packageName, flags, userId) {
        ...
        Java.use("android.app.ApplicationPackageManager").getPackageInfoAsUser.overload('java.lang.String', 'android.content.pm.PackageManager$PackageInfoFlags', 'int').implementation = function (packageName, flags, userId) {
            if (RootPackages.indexOf(packageName) > -1) {
                packageName = "fake.fake.fake.fake.fake.package";
            }
            return this.getPackageInfoAsUser(packageName, flags, userId);
